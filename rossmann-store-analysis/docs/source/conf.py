...
# rossmann_store_analysis documentation build
...
from rossmann_store_analysis import __version__ as release

# -- Project information -----------------------------------------------------

project = "rossmann_store_analysis"
author = "Kedro"
...
htmlhelp_basename = "rossmann_store_analysisdoc"
...
latex_documents = [
    (
        master_doc,
        "rossmann_store_analysis.tex",
        "rossmann_store_analysis Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "rossmann_store_analysis",
        "Project rossmann_store_analysis codebase.",
        "Data-Science",
    )
]
